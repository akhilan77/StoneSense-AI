...
# NOTE: your existing /predict/risk and /predict/image handlers (in
# routes/predict.py) just need one addition each: accept `hospital_id`
# in the request body/form, and after computing the prediction, persist
# a Prediction row tagged with that hospital_id. See INTEGRATION.md for
# the exact 4-line diff — nothing about the ML/DL inference itself changes.
