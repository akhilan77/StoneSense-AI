...
// NOTE: this has no real authentication yet (matches current project stage —
// hospital identity is still just the dropdown selection, stored in
// HospitalContext). When real auth is added, `enterHospital` /
// `enterDeveloper` become the point where a login request runs and a
// role + hospital_id come back from the server instead of local state.
